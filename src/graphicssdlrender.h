...
int graphicssdlrender_drawCropped(
    const char* texname, int x, int y, float alpha,
...
// Draw a texture cropped.
// Returns 1 on success, 0 when there is no such texture.

int graphicssdlrender_draw(
    const char* texname, int x, int y, float alpha,
    unsigned int drawwidth, unsigned int drawheight,
    int rotationcenterx, int rotationcentery, double rotationangle,
    int horiflipped,
...
void graphicssdlrender_drawRectangle(
